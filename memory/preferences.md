...
- The precise historical backfill (2026-09) stores **DK/FD/Pinnacle** (3 books). bet365 was DROPPED from the backfill 2026-09-01: the Odds API historical per-event endpoint carries no bet365 MLB depth (probe 2026-08-30 showed it absent from the full 33-book slate), so paying to request it just adds an always-empty book. bet365 remains a LIVE executable book going forward; it simply has no historical corpus. Everything except these is dropped.
